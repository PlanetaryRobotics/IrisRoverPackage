...
#ifndef MC_INTERFACE_DEFS_H_
#define MC_INTERFACE_DEFS_H_
...
// --- MC i2c Register
typedef enum i2cRegisterAddress
{
    ...
    REG_MC_STATUS           = 13,   // RW - 1 Byte
    REG_MC_FAULT            = 14,   // RW - 1 Byte
    REG_MAX                 = 16
} i2cRegisterAddress;

//uint8_t mc_i2cCmdLen[REG_MAX] = {
//                                 1, // REG_I2C_ADDRESS
//                                 4, // REG_TARGET_POSITION
//                                 1, // REG_TARGET_SPEED
//                                 4, // REG_CURRENT_POSITION
//                                 1, // REG_CURRENT_SPEED
//                                 2, // REG_MOTOR_CURRENT
//                                 2, // REG_P_CURRENT
//                                 2, // REG_I_CURRENT
...
typedef struct MotorControllerStruct
{
    uint8_t up_to_date;
