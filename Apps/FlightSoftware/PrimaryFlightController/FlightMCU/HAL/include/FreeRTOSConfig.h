...
#define configTOTAL_HEAP_SIZE		  ( ( size_t ) 63480 ) // now that NetworkManager resources are statically allocated, dropped this by the size of the removed NM resources
