...
// NOTE: Observed a crash (`errCOULD_NOT_ALLOCATE_REQUIRED_MEMORY`) when
// allocating tasks with this == 63840. That happened after adding a new task
// (`Wf121BgApiPassthroughTxTask`). This new task was shrunk to a more
// reasonable stack size and the heap was bumped up by the original size of the
// new task (384B) and then given some extra room.
