...
#include <CubeRover/MathSender/MathSenderComponentAc.hpp>
    ...
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      void connect_to_mathIn(
          ...
          CubeRover::InputMathResultPort *const mathIn /*!< The port*/
      );
    ...
    public:
      ...
      //!
      CubeRover::InputMathOpPort* get_from_mathOut(
          const NATIVE_INT_TYPE portNum /*!< The port number*/
      );
    ...
    private:
      ...
      //!
      CubeRover::OutputMathResultPort m_to_mathIn[1];
    ...
    private:
      ...
      //!
      CubeRover::InputMathOpPort m_from_mathOut[1];
