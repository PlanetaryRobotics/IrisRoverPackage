...
//
    ...
    uint32_t MotorControlComponentImpl::regSizeMap(MC_RegisterAddress reg)
    {
        switch (reg)
        {
    ...
    MotorControlComponentImpl::sendAllMotorsData(const MC_RegisterAddress reg, void *_data)
    {
