...
#include "i2c.h"
    ...
    static const uint32_t I2C_MASTER_READ_WRITE_MAX_DELAY_CYCLES = 16000000; // 1.6M cycles ~= 0.1s (probably greater because we do a few ops during each delay loop)
