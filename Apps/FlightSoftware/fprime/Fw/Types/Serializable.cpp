...
namespace Fw
{
...
#if FW_HAS_16_BIT == 1
    SerializeStatus SerializeBufferBase::serialize(U16 val, bool forceBigEndian)
    {
        if (this->m_serLoc + (NATIVE_UINT_TYPE)sizeof(val) - 1 >= this->getBuffCapacity())
        {
            return FW_SERIALIZE_NO_ROOM_LEFT;
    ...
    SerializeStatus SerializeBufferBase::serialize(I16 val, bool forceBigEndian)
    {
        if (this->m_serLoc + (NATIVE_UINT_TYPE)sizeof(val) - 1 >= this->getBuffCapacity())
        {
            return FW_SERIALIZE_NO_ROOM_LEFT;
...
#endif
#if FW_HAS_32_BIT == 1
    SerializeStatus SerializeBufferBase::serialize(U32 val, bool forceBigEndian)
    {
        if (this->m_serLoc + (NATIVE_UINT_TYPE)sizeof(val) - 1 >= this->getBuffCapacity())
        {
            return FW_SERIALIZE_NO_ROOM_LEFT;
    ...
    SerializeStatus SerializeBufferBase::serialize(I32 val, bool forceBigEndian)
    {
        if (this->m_serLoc + (NATIVE_UINT_TYPE)sizeof(val) - 1 >= this->getBuffCapacity())
        {
            return FW_SERIALIZE_NO_ROOM_LEFT;
...
#if FW_HAS_64_BIT == 1
    SerializeStatus SerializeBufferBase::serialize(U64 val, bool forceBigEndian)
    {
        if (this->m_serLoc + (NATIVE_UINT_TYPE)sizeof(val) - 1 >= this->getBuffCapacity())
        {
            return FW_SERIALIZE_NO_ROOM_LEFT;
        ...
        if (forceBigEndian)
        {
            // MSB first
            const U64 mask = 0xFF;
            this->getBuffAddr()[this->m_serLoc + 0] = (U8)((val & (mask << 56)) >> 56);
            this->getBuffAddr()[this->m_serLoc + 1] = (U8)((val & (mask << 48)) >> 48);
            this->getBuffAddr()[this->m_serLoc + 2] = (U8)((val & (mask << 40)) >> 40);
            this->getBuffAddr()[this->m_serLoc + 3] = (U8)((val & (mask << 32)) >> 32);
            this->getBuffAddr()[this->m_serLoc + 4] = (U8)((val & (mask << 24)) >> 24);
            this->getBuffAddr()[this->m_serLoc + 5] = (U8)((val & (mask << 16)) >> 16);
            this->getBuffAddr()[this->m_serLoc + 6] = (U8)((val & (mask << 8)) >> 8);
            this->getBuffAddr()[this->m_serLoc + 7] = (U8)((val & (mask << 0)) >> 0);
        }
        else
        {
    ...
    SerializeStatus SerializeBufferBase::serialize(I64 val, bool forceBigEndian)
    {
        if (this->m_serLoc + (NATIVE_UINT_TYPE)sizeof(val) - 1 >= this->getBuffCapacity())
        {
            return FW_SERIALIZE_NO_ROOM_LEFT;
    ...
    {
        if (this->m_serLoc + (NATIVE_UINT_TYPE)sizeof(void *) - 1 >= this->getBuffCapacity())
        {
            return FW_SERIALIZE_NO_ROOM_LEFT;
        }
    ...
    SerializeStatus SerializeBufferBase::serialize(const U8 *buff, NATIVE_UINT_TYPE length, bool noLength)
    {
        ...
        if (not noLength)
        {
            // Serialize length as BIG endian (per [FPrime docs](https://nasa.github.io/fprime/v1.5/UsersGuide/api/python/fprime/html/modules/fprime/common/models/serialize/string_type.html))
            stat = this->serialize(static_cast<FwBuffSizeType>(length), true);
        ...
        const SerializeBufferBase &val)
    {
        ...
        if (this->m_serLoc + size + (NATIVE_UINT_TYPE)sizeof(FwBuffSizeType) > this->getBuffCapacity())
        {
            return FW_SERIALIZE_NO_ROOM_LEFT;
        }
        ...
        // Serialize length as BIG endian (per [FPrime docs](https://nasa.github.io/fprime/v1.5/UsersGuide/api/python/fprime/html/modules/fprime/common/models/serialize/string_type.html))
        SerializeStatus stat = this->serialize((FwBuffSizeType)size, true);
        if (stat != FW_SERIALIZE_OK)
        {
            return stat;
        }
...
#if FW_HAS_16_BIT == 1
    SerializeStatus SerializeBufferBase::deserialize(U16 &val, bool forceBigEndian)
    {
        // check for room
        if (this->getBuffLength() == this->m_deserLoc)
        {
        ...
        {
            // MSB first
            val = ((U16)this->getBuffAddr()[this->m_deserLoc + 1] << 0) | ((U16)this->getBuffAddr()[this->m_deserLoc + 0] << 8);
        }
        else
        {
    ...
    SerializeStatus SerializeBufferBase::deserialize(I16 &val, bool forceBigEndian)
    {
        // check for room
        if (this->getBuffLength() == this->m_deserLoc)
        {
        ...
        {
            // MSB first
            val = ((I16)this->getBuffAddr()[this->m_deserLoc + 1] << 0) | ((I16)this->getBuffAddr()[this->m_deserLoc + 0] << 8);
        }
        else
        {
...
#endif
#if FW_HAS_32_BIT == 1
    SerializeStatus SerializeBufferBase::deserialize(U32 &val, bool forceBigEndian)
    {
        // check for room
        if (this->getBuffLength() == this->m_deserLoc)
        {
        ...
        {
            // MSB first
            val = ((U32)this->getBuffAddr()[this->m_deserLoc + 3] << 0) | ((U32)this->getBuffAddr()[this->m_deserLoc + 2] << 8) | ((U32)this->getBuffAddr()[this->m_deserLoc + 1] << 16) | ((U32)this->getBuffAddr()[this->m_deserLoc + 0] << 24);
        }
        else
        {
    ...
    SerializeStatus SerializeBufferBase::deserialize(I32 &val, bool forceBigEndian)
    {
        // check for room
        if (this->getBuffLength() == this->m_deserLoc)
        {
    ...
    SerializeStatus SerializeBufferBase::deserialize(U64 &val, bool forceBigEndian)
    {
        // check for room
        if (this->getBuffLength() == this->m_deserLoc)
        {
    ...
    SerializeStatus SerializeBufferBase::deserialize(I64 &val, bool forceBigEndian)
    {
        // check for room
        if (this->getBuffLength() == this->m_deserLoc)
        {
    ...
    SerializeStatus SerializeBufferBase::deserialize(U8 *buff, NATIVE_UINT_TYPE &length, bool noLength)
    {
        ...
        if (not noLength)
        {
            ...
            // Deserialize length as BIG endian (per [FPrime docs](https://nasa.github.io/fprime/v1.5/UsersGuide/api/python/fprime/html/modules/fprime/common/models/serialize/string_type.html))
            SerializeStatus stat = this->deserialize(storedLength, true);
    ...
    SerializeStatus SerializeBufferBase::deserialize(SerializeBufferBase &val)
    {
        ...
        FwBuffSizeType storedLength;
        // Deserialize length as BIG endian (per [FPrime docs](https://nasa.github.io/fprime/v1.5/UsersGuide/api/python/fprime/html/modules/fprime/common/models/serialize/string_type.html))
        stat = this->deserialize(storedLength, true);
