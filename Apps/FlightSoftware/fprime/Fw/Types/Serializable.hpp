...
namespace Fw
{
    ...
    public:
...
#if FW_HAS_16_BIT == 1
        SerializeStatus serialize(U16 val, bool forceBigEndian = false); //!< serialize 16-bit unsigned int
        SerializeStatus serialize(I16 val, bool forceBigEndian = false); //!< serialize 16-bit signed int
#endif
#if FW_HAS_32_BIT == 1
        SerializeStatus serialize(U32 val, bool forceBigEndian = false); //!< serialize 32-bit unsigned int
        SerializeStatus serialize(I32 val, bool forceBigEndian = false); //!< serialize 32-bit signed int
#endif
#if FW_HAS_64_BIT == 1
        SerializeStatus serialize(U64 val, bool forceBigEndian = false); //!< serialize 64-bit unsigned int
        SerializeStatus serialize(I64 val, bool forceBigEndian = false); //!< serialize 64-bit signed int
#endif
...
#if FW_HAS_32_BIT == 1
        SerializeStatus deserialize(U32 &val, bool forceBigEndian = false); //!< deserialize 32-bit unsigned int
        SerializeStatus deserialize(I32 &val, bool forceBigEndian = false); //!< deserialize 32-bit signed int
#endif
#if FW_HAS_64_BIT == 1
        SerializeStatus deserialize(U64 &val, bool forceBigEndian = false); //!< deserialize 64-bit unsigned int
        SerializeStatus deserialize(I64 &val, bool forceBigEndian = false); //!< deserialize 64-bit signed int
#endif
        ...
        PRIVATE : void copyFrom(const SerializeBufferBase &src); //!< copy data from source buffer
