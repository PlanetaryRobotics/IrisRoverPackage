// ====================================================================== 
// \title  DecodeDataComponentAc.hpp
// \author Auto-generated
// \brief  cpp file for DecodeData component base class
//
// \copyright
...
namespace CubeRoverGround {
  ...
  namespace {
    ...
    typedef enum {
      DECODEDATA_COMPONENT_EXIT = Fw::ActiveComponentBase::ACTIVE_COMPONENT_EXIT,
      CMD_DECODEDATA_SETTINGS,
      CMD_DECODEDATA_TOGGLE,
      CMD_DECODEDATA_SKIP
    } MsgTypeEnum;
  ...
  Fw::InputCmdPort *DecodeDataComponentBase ::
  ...
  Svc::InputSchedPort *DecodeDataComponentBase ::
  ...
  Fw::InputTlmPort *DecodeDataComponentBase ::
    ...
    regCommands(void)
  {
    ...
    this->m_cmdRegOut_OutputPort[0].invoke(
        this->getIdBase() + OPCODE_DECODEDATA_SETTINGS
    );
    this->m_cmdRegOut_OutputPort[0].invoke(
        this->getIdBase() + OPCODE_DECODEDATA_TOGGLE
    );
    this->m_cmdRegOut_OutputPort[0].invoke(
        this->getIdBase() + OPCODE_DECODEDATA_SKIP
    );
  }
  ...
  DecodeDataComponentBase ::
#if FW_OBJECT_NAMES == 1
    DecodeDataComponentBase(const char* compName) :
  ...
  NATIVE_INT_TYPE DecodeDataComponentBase ::
    ...
    )
  {
    ...
    FW_ASSERT(callComp);
    DecodeDataComponentBase* compPtr =
      (DecodeDataComponentBase*) callComp;

    const U32 idBase = callComp->getIdBase();
    FW_ASSERT(opCode >= idBase, opCode, idBase);
    switch (opCode - idBase) {

      case OPCODE_DECODEDATA_SETTINGS: /*!< DecodeData Settings */
        compPtr->DecodeData_Settings_cmdHandlerBase(
            opCode,
            cmdSeq,
            args
        );
      ...
      case OPCODE_DECODEDATA_TOGGLE: /*!< Toggle DecodeData On/Off. */
        compPtr->DecodeData_Toggle_cmdHandlerBase(
            opCode,
            cmdSeq,
            args
        );
      ...
      case OPCODE_DECODEDATA_SKIP: /*!< Skip next sample */
        compPtr->DecodeData_Skip_cmdHandlerBase(
            opCode,
            cmdSeq,
            args
        );
  ...
  void DecodeDataComponentBase ::
    DecodeData_Settings_cmdHandlerBase(
        FwOpcodeType opCode,
        U32 cmdSeq,
        Fw::CmdArgBuffer &args
    )
  {
    ...
    this->DecodeData_Settings_preMsgHook(opCode,cmdSeq);
    ...
    // Serialize for IPC
    _status = msg.serialize((NATIVE_INT_TYPE)CMD_DECODEDATA_SETTINGS);
    FW_ASSERT (
  ...
  void DecodeDataComponentBase::
    DecodeData_Settings_preMsgHook(
        FwOpcodeType opCode,
        U32 cmdSeq
    )
  {
  ...
  void DecodeDataComponentBase ::
    DecodeData_Toggle_cmdHandlerBase(
        FwOpcodeType opCode,
        U32 cmdSeq,
        Fw::CmdArgBuffer &args
    )
  {
    ...
    // Call pre-message hook
    this->DecodeData_Toggle_preMsgHook(opCode,cmdSeq);
    ...
    // Serialize for IPC
    _status = msg.serialize((NATIVE_INT_TYPE)CMD_DECODEDATA_TOGGLE);
    FW_ASSERT (
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<AssertArg>(_status)
        );
  ...
  void DecodeDataComponentBase ::
    DecodeData_Skip_cmdHandlerBase(
        FwOpcodeType opCode,
        U32 cmdSeq,
        Fw::CmdArgBuffer &args
    )
  {
    ...
    // Call pre-message hook
    this->DecodeData_Skip_preMsgHook(opCode,cmdSeq);
    ...
    // Serialize for IPC
    _status = msg.serialize((NATIVE_INT_TYPE)CMD_DECODEDATA_SKIP);
    FW_ASSERT (
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<AssertArg>(_status)
        );
  ...
  void DecodeDataComponentBase ::
    tlmWrite_DecodeData_Output(F32 arg)
  {
    ...
    if (this->m_tlmIn_OutputPort[0].isConnected()) {
      ...
      _id = this->getIdBase() + CHANNELID_DECODEDATA_OUTPUT;
  ...
  Fw::Time DecodeDataComponentBase ::
    getTime(void) 
  {
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
      Fw::Time _time;
  ...
  void DecodeDataComponentBase ::
    log_ACTIVITY_LO_DecodeData_SettingsChanged(
    ...
    )
  {
    ...
    _id = this->getIdBase() + EVENTID_DECODEDATA_SETTINGSCHANGED;
  ...
  Fw::QueuedComponentBase::MsgDispatchStatus DecodeDataComponentBase ::
    doDispatch(void)
  {
    ComponentIpcSerializableBuffer msg;
    ...
    if (msgType == DECODEDATA_COMPONENT_EXIT) {
    ...
    switch (msgType) {
      ...
      // Handle command DecodeData_Settings
      case CMD_DECODEDATA_SETTINGS: {
        // Deserialize opcode
        FwOpcodeType opCode;
        ...
        this->DecodeData_Settings_cmdHandler(
            opCode,
            cmdSeq,
      ...
      // Handle command DecodeData_Toggle
      case CMD_DECODEDATA_TOGGLE: {
        // Deserialize opcode
        FwOpcodeType opCode;
        deserStatus = msg.deserialize(opCode);
        FW_ASSERT (
...
#endif
        // Call handler function
        this->DecodeData_Toggle_cmdHandler(opCode, cmdSeq);

        break;

      }

      // Handle command DecodeData_Skip
      case CMD_DECODEDATA_SKIP: {
        // Deserialize opcode
        FwOpcodeType opCode;
        deserStatus = msg.deserialize(opCode);
        FW_ASSERT (
...
#endif
        // Call handler function
        this->DecodeData_Skip_cmdHandler(opCode, cmdSeq);
