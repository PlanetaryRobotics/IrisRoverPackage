...
// \brief  cpp file for EncodeCmd component base class
//
// \copyright
...
namespace CubeRoverGround {
  ...
  namespace {
    ...
    typedef enum {
      ENCODECMD_COMPONENT_EXIT = Fw::ActiveComponentBase::ACTIVE_COMPONENT_EXIT,
  ...
  Fw::InputCmdPort *EncodeCmdComponentBase ::
  ...
  Svc::InputSchedPort *EncodeCmdComponentBase ::
  ...
  Fw::InputTlmPort *EncodeCmdComponentBase ::
  ...
  EncodeCmdComponentBase ::
    ...
    EncodeCmdComponentBase(const char* compName) :
  ...
  NATIVE_INT_TYPE EncodeCmdComponentBase ::
    ...
    )
  {
    ...
    FW_ASSERT(callComp);
    EncodeCmdComponentBase* compPtr =
      (EncodeCmdComponentBase*) callComp;
  ...
  Fw::Time EncodeCmdComponentBase ::
    getTime(void) 
  {
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
      Fw::Time _time;
  ...
  Fw::QueuedComponentBase::MsgDispatchStatus EncodeCmdComponentBase ::
    doDispatch(void)
  {
    ComponentIpcSerializableBuffer msg;
    ...
    if (msgType == ENCODECMD_COMPONENT_EXIT) {
