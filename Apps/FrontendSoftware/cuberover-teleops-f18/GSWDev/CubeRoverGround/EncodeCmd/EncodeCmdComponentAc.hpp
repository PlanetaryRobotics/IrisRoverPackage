// ====================================================================== 
// \title  EncodeCmdComponentAc.hpp
// \author Auto-generated
// \brief  hpp file for EncodeCmd component base class
//
// \copyright
...
#ifndef ENCODECMD_COMP_HPP_
#define ENCODECMD_COMP_HPP_
...
namespace CubeRoverGround {
  ...
  //! \class EncodeCmdComponentBase
  //! \brief Auto-generated base for EncodeCmd component
  //!
  class EncodeCmdComponentBase :
    public Fw::QueuedComponentBase
  {
    ...
    //!
    friend class EncodeCmdComponentBaseFriend;
  ...
  PROTECTED:
    ...
    //! Construct a EncodeCmdComponentBase object
    //!
    EncodeCmdComponentBase(
        const char* compName /*!< Component name*/
    );
#else
    //! Construct a EncodeCmdComponentBase object
    //!
    EncodeCmdComponentBase(void);
#endif

    //! Initialize a EncodeCmdComponentBase object
    //!
    void init(
    ...
    //! Destroy a EncodeCmdComponentBase object
    //!
    virtual ~EncodeCmdComponentBase(void);
