...
// \brief  cpp file for ImgProc component base class
//
// \copyright
...
namespace CubeRoverGround {
  ...
  namespace {
    ...
    typedef enum {
      IMGPROC_COMPONENT_EXIT = Fw::ActiveComponentBase::ACTIVE_COMPONENT_EXIT,
  ...
  Fw::InputCmdPort *ImgProcComponentBase ::
  ...
  Svc::InputSchedPort *ImgProcComponentBase ::
  ...
  Fw::InputTlmPort *ImgProcComponentBase ::
  ...
  ImgProcComponentBase ::
    ...
    ImgProcComponentBase(const char* compName) :
  ...
  NATIVE_INT_TYPE ImgProcComponentBase ::
    ...
    )
  {
    ...
    FW_ASSERT(callComp);
    ImgProcComponentBase* compPtr =
      (ImgProcComponentBase*) callComp;
  ...
  Fw::QueuedComponentBase::MsgDispatchStatus ImgProcComponentBase ::
    doDispatch(void)
  {
    ComponentIpcSerializableBuffer msg;
    ...
    if (msgType == IMGPROC_COMPONENT_EXIT) {
