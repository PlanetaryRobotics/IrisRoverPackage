// ====================================================================== 
// \title  ImgProcComponentAc.hpp
// \author Auto-generated
// \brief  hpp file for ImgProc component base class
//
// \copyright
...
#ifndef IMGPROC_COMP_HPP_
#define IMGPROC_COMP_HPP_
...
namespace CubeRoverGround {
  ...
  //! \class ImgProcComponentBase
  //! \brief Auto-generated base for ImgProc component
  //!
  class ImgProcComponentBase :
    public Fw::QueuedComponentBase
  {
    ...
    //!
    friend class ImgProcComponentBaseFriend;
  ...
  PROTECTED:
    ...
    //! Construct a ImgProcComponentBase object
    //!
    ImgProcComponentBase(
        const char* compName /*!< Component name*/
    );
#else
    //! Construct a ImgProcComponentBase object
    //!
    ImgProcComponentBase(void);
#endif

    //! Initialize a ImgProcComponentBase object
    //!
    void init(
    ...
    //! Destroy a ImgProcComponentBase object
    //!
    virtual ~ImgProcComponentBase(void);
