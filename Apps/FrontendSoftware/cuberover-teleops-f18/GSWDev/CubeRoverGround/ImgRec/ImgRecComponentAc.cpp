...
// \brief  cpp file for ImgRec component base class
//
// \copyright
...
namespace CubeRoverGround {
  ...
  namespace {
    ...
    typedef enum {
      IMGREC_COMPONENT_EXIT = Fw::ActiveComponentBase::ACTIVE_COMPONENT_EXIT,
  ...
  Fw::InputCmdPort *ImgRecComponentBase ::
  ...
  Svc::InputSchedPort *ImgRecComponentBase ::
  ...
  Fw::InputTlmPort *ImgRecComponentBase ::
  ...
  ImgRecComponentBase ::
    ...
    ImgRecComponentBase(const char* compName) :
  ...
  NATIVE_INT_TYPE ImgRecComponentBase ::
    ...
    )
  {
    ...
    FW_ASSERT(callComp);
    ImgRecComponentBase* compPtr =
      (ImgRecComponentBase*) callComp;
  ...
  Fw::QueuedComponentBase::MsgDispatchStatus ImgRecComponentBase ::
    doDispatch(void)
  {
    ComponentIpcSerializableBuffer msg;
    ...
    if (msgType == IMGREC_COMPONENT_EXIT) {
