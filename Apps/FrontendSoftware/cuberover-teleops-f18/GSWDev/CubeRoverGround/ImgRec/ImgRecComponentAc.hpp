// ====================================================================== 
// \title  ImgRecComponentAc.hpp
// \author Auto-generated
// \brief  hpp file for ImgRec component base class
//
// \copyright
...
#ifndef IMGREC_COMP_HPP_
#define IMGREC_COMP_HPP_
...
namespace CubeRoverGround {
  ...
  //! \class ImgRecComponentBase
  //! \brief Auto-generated base for ImgRec component
  //!
  class ImgRecComponentBase :
    public Fw::QueuedComponentBase
  {
    ...
    //!
    friend class ImgRecComponentBaseFriend;
  ...
  PROTECTED:
    ...
    //! Construct a ImgRecComponentBase object
    //!
    ImgRecComponentBase(
    ...
    //! Construct a ImgRecComponentBase object
    //!
    ImgRecComponentBase(void);
#endif

    //! Initialize a ImgRecComponentBase object
    //!
    void init(
    ...
    //! Destroy a ImgRecComponentBase object
    //!
    virtual ~ImgRecComponentBase(void);
