...
// \title  ImgRecImpl.hpp
// \author sofiahurtado
// \brief  hpp file for ImgRec component implementation class
//
// \copyright
...
namespace CubeRoverGround {
  ...
  class ImgRecComponentImpl :
    public ImgRecComponentBase
  {
