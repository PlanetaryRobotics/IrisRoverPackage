...
// \brief  hpp file for Localization component base class
//
// \copyright
...
#ifndef LOCALIZATION_COMP_HPP_
#define LOCALIZATION_COMP_HPP_
...
namespace CubeRoverGround {
  ...
  //! \class LocalizationComponentBase
  //! \brief Auto-generated base for Localization component
  //!
  class LocalizationComponentBase :
    public Fw::QueuedComponentBase
  {
    ...
    //!
    friend class LocalizationComponentBaseFriend;
  ...
  PROTECTED:
    ...
    //! Construct a LocalizationComponentBase object
    //!
    ...
    //! Construct a LocalizationComponentBase object
    //!
    LocalizationComponentBase(void);
#endif

    //! Initialize a LocalizationComponentBase object
    //!
    void init(
    ...
    //! Destroy a LocalizationComponentBase object
    //!
    virtual ~LocalizationComponentBase(void);
