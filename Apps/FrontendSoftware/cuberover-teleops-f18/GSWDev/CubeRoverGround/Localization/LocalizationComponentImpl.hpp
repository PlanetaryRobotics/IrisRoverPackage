// ====================================================================== 
// \title  LocalizationImpl.hpp
// \author sofiahurtado
// \brief  hpp file for Localization component implementation class
//
// \copyright
...
namespace CubeRoverGround {
  ...
  class LocalizationComponentImpl :
    public LocalizationComponentBase
  {
    ...
    public:
      ...
      //! Initialize object Localization
      //!
      void init(
