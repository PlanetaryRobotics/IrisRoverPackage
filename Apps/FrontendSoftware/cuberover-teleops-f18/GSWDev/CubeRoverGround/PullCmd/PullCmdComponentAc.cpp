...
// \brief  cpp file for PullCmd component base class
//
// \copyright
...
namespace CubeRoverGround {
  ...
  namespace {
    ...
    typedef enum {
      PULLCMD_COMPONENT_EXIT = Fw::ActiveComponentBase::ACTIVE_COMPONENT_EXIT,
  ...
  Fw::InputCmdPort *PullCmdComponentBase ::
  ...
  Svc::InputSchedPort *PullCmdComponentBase ::
  ...
  Fw::InputTlmPort *PullCmdComponentBase ::
  ...
  PullCmdComponentBase ::
    ...
    PullCmdComponentBase(const char* compName) :
  ...
  NATIVE_INT_TYPE PullCmdComponentBase ::
    ...
    )
  {
    ...
    FW_ASSERT(callComp);
    PullCmdComponentBase* compPtr =
      (PullCmdComponentBase*) callComp;
  ...
  Fw::QueuedComponentBase::MsgDispatchStatus PullCmdComponentBase ::
    doDispatch(void)
  {
    ComponentIpcSerializableBuffer msg;
    ...
    if (msgType == PULLCMD_COMPONENT_EXIT) {
