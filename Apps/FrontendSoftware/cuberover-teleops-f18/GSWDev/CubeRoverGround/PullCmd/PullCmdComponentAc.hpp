// ====================================================================== 
// \title  PullCmdComponentAc.hpp
// \author Auto-generated
// \brief  hpp file for PullCmd component base class
//
// \copyright
...
#ifndef PULLCMD_COMP_HPP_
#define PULLCMD_COMP_HPP_
...
namespace CubeRoverGround {
  ...
  //! \class PullCmdComponentBase
  //! \brief Auto-generated base for PullCmd component
  //!
  class PullCmdComponentBase :
    public Fw::QueuedComponentBase
  {
    ...
    //!
    friend class PullCmdComponentBaseFriend;
  ...
  PROTECTED:
    ...
    //! Construct a PullCmdComponentBase object
    //!
    PullCmdComponentBase(
        const char* compName /*!< Component name*/
    );
#else
    //! Construct a PullCmdComponentBase object
    //!
    PullCmdComponentBase(void);
#endif

    //! Initialize a PullCmdComponentBase object
    //!
    void init(
    ...
    //! Destroy a PullCmdComponentBase object
    //!
    virtual ~PullCmdComponentBase(void);
