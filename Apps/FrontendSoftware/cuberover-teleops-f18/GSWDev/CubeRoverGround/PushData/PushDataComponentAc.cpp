...
// \brief  cpp file for PushData component base class
//
// \copyright
...
namespace CubeRoverGround {
  ...
  namespace {
    ...
    typedef enum {
      PUSHDATA_COMPONENT_EXIT = Fw::ActiveComponentBase::ACTIVE_COMPONENT_EXIT,
  ...
  Fw::InputCmdPort *PushDataComponentBase ::
  ...
  Svc::InputSchedPort *PushDataComponentBase ::
  ...
  Fw::InputTlmPort *PushDataComponentBase ::
  ...
  PushDataComponentBase ::
    ...
    PushDataComponentBase(const char* compName) :
  ...
  NATIVE_INT_TYPE PushDataComponentBase ::
    ...
    )
  {
    ...
    FW_ASSERT(callComp);
    PushDataComponentBase* compPtr =
      (PushDataComponentBase*) callComp;
  ...
  Fw::QueuedComponentBase::MsgDispatchStatus PushDataComponentBase ::
    doDispatch(void)
  {
    ComponentIpcSerializableBuffer msg;
    ...
    if (msgType == PUSHDATA_COMPONENT_EXIT) {
