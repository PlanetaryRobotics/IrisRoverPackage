// ====================================================================== 
// \title  PushDataComponentAc.hpp
// \author Auto-generated
// \brief  hpp file for PushData component base class
//
// \copyright
...
#ifndef PUSHDATA_COMP_HPP_
#define PUSHDATA_COMP_HPP_
...
namespace CubeRoverGround {
  ...
  //! \class PushDataComponentBase
  //! \brief Auto-generated base for PushData component
  //!
  class PushDataComponentBase :
    public Fw::QueuedComponentBase
  {
    ...
    //!
    friend class PushDataComponentBaseFriend;
  ...
  PROTECTED:
    ...
    //! Construct a PushDataComponentBase object
    //!
    PushDataComponentBase(
        const char* compName /*!< Component name*/
    );
#else
    //! Construct a PushDataComponentBase object
    //!
    PushDataComponentBase(void);
#endif

    //! Initialize a PushDataComponentBase object
    //!
    void init(
    ...
    //! Destroy a PushDataComponentBase object
    //!
    virtual ~PushDataComponentBase(void);
