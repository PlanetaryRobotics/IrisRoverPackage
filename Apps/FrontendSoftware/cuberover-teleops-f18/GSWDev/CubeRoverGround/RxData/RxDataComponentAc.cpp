...
// \brief  cpp file for RxData component base class
//
// \copyright
...
namespace CubeRoverGround {
  ...
  namespace {
    ...
    typedef enum {
      RXDATA_COMPONENT_EXIT = Fw::ActiveComponentBase::ACTIVE_COMPONENT_EXIT,
  ...
  Fw::InputCmdPort *RxDataComponentBase ::
  ...
  Svc::InputSchedPort *RxDataComponentBase ::
  ...
  Fw::InputTlmPort *RxDataComponentBase ::
  ...
  RxDataComponentBase ::
    ...
    RxDataComponentBase(const char* compName) :
  ...
  NATIVE_INT_TYPE RxDataComponentBase ::
    ...
    )
  {
    ...
    FW_ASSERT(callComp);
    RxDataComponentBase* compPtr =
      (RxDataComponentBase*) callComp;
  ...
  Fw::QueuedComponentBase::MsgDispatchStatus RxDataComponentBase ::
    doDispatch(void)
  {
    ComponentIpcSerializableBuffer msg;
    ...
    if (msgType == RXDATA_COMPONENT_EXIT) {
