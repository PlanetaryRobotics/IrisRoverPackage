// ====================================================================== 
// \title  RxDataComponentAc.hpp
// \author Auto-generated
// \brief  hpp file for RxData component base class
//
// \copyright
...
#ifndef RXDATA_COMP_HPP_
#define RXDATA_COMP_HPP_
...
namespace CubeRoverGround {
  ...
  //! \class RxDataComponentBase
  //! \brief Auto-generated base for RxData component
  //!
  class RxDataComponentBase :
    public Fw::QueuedComponentBase
  {
    ...
    //!
    friend class RxDataComponentBaseFriend;
  ...
  PROTECTED:
    ...
    //! Construct a RxDataComponentBase object
    //!
    RxDataComponentBase(
    ...
    //! Construct a RxDataComponentBase object
    //!
    RxDataComponentBase(void);
#endif

    //! Initialize a RxDataComponentBase object
    //!
    void init(
    ...
    //! Destroy a RxDataComponentBase object
    //!
    virtual ~RxDataComponentBase(void);
