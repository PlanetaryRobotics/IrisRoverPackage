...
// \brief  cpp file for TelemData component base class
//
// \copyright
...
namespace CubeRoverGround {
  ...
  namespace {
    ...
    typedef enum {
      TELEMDATA_COMPONENT_EXIT = Fw::ActiveComponentBase::ACTIVE_COMPONENT_EXIT,
  ...
  Fw::InputCmdPort *TelemDataComponentBase ::
  ...
  Svc::InputSchedPort *TelemDataComponentBase ::
  ...
  Fw::InputTlmPort *TelemDataComponentBase ::
  ...
  TelemDataComponentBase ::
    ...
    TelemDataComponentBase(const char* compName) :
  ...
  NATIVE_INT_TYPE TelemDataComponentBase ::
    ...
    )
  {
    ...
    FW_ASSERT(callComp);
    TelemDataComponentBase* compPtr =
      (TelemDataComponentBase*) callComp;
  ...
  Fw::Time TelemDataComponentBase ::
    getTime(void) 
  {
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
      Fw::Time _time;
  ...
  Fw::QueuedComponentBase::MsgDispatchStatus TelemDataComponentBase ::
    doDispatch(void)
  {
    ComponentIpcSerializableBuffer msg;
    ...
    if (msgType == TELEMDATA_COMPONENT_EXIT) {
