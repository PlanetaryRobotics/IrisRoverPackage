// ====================================================================== 
// \title  TelemDataComponentAc.hpp
// \author Auto-generated
// \brief  hpp file for TelemData component base class
//
// \copyright
...
#ifndef TELEMDATA_COMP_HPP_
#define TELEMDATA_COMP_HPP_
...
namespace CubeRoverGround {
  ...
  //! \class TelemDataComponentBase
  //! \brief Auto-generated base for TelemData component
  //!
  class TelemDataComponentBase :
    public Fw::QueuedComponentBase
  {
    ...
    //!
    friend class TelemDataComponentBaseFriend;
  ...
  PROTECTED:
    ...
    //! Construct a TelemDataComponentBase object
    //!
    TelemDataComponentBase(
        const char* compName /*!< Component name*/
    );
#else
    //! Construct a TelemDataComponentBase object
    //!
    TelemDataComponentBase(void);
#endif

    //! Initialize a TelemDataComponentBase object
    //!
    void init(
    ...
    //! Destroy a TelemDataComponentBase object
    //!
    virtual ~TelemDataComponentBase(void);
