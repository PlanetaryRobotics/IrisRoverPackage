...
/*
CubeRoverGround::DecodeData decodeData("decodeData");
CubeRoverGround::EncodeCmd encodeCmd("encodeCmd");
CubeRoverGround::ImgProc imgProc("imgProc");
CubeRoverGround::ImgRec imgRec("imgRec");
CubeRoverGround::Localization localization("localization");
CubeRoverGround::PullCmd pullCmd("pullCmd");
CubeRoverGround::PushData pushData("pushData");
CubeRoverGround::RxData rxData("rxData");
CubeRoverGround::TelemData telemData("telemData");
CubeRoverGround::TxCmd txCmd("txCmd");
...
void constructApp(int port_number, char* hostname) {
    ...
    /*TODO: figure out what these init parameters do */ 
    /*
    decodeData.init(10,0);
    encodeCmd.init(10,0);
    imgProc.init(10,0);
    imgRec.init(10,0);
    localization.init(10,0);
    pullCmd.init(10,0);
    pushData.init(10,0);
    rxData.init(10,0);
    telemData.init(10,0);
    ...
    */
    ...
    /*
    decodeData.regCommands();
    encodeCmd.regCommands();
    imgProc.regCommands();
    imgRec.regCommands();
    localization.regCommands();
    pullCmd.regCommands();
    pushData.regCommands();
    rxData.regCommands();
    telemData.regCommands();
    txCmd.regCommands();
    */
    ...
    /*
    decodeData.start(0,100,10*1024);
    encodeCmd.start(0,100,10*1024);
    imgProc.start(0,100,10*1024);
    imgRec.start(0,100,10*1024);
    localization.start(0,100,10*1024);
    pullCmd.start(0,100,10*1024);
    pushData.start(0,100,10*1024);
    rxData.start(0,100,10*1024);
    telemData.start(0,100,10*1024);
    txCmd.start(0,100,10*1024);
    */
