...
// \brief  cpp file for TxCmd component base class
//
// \copyright
...
namespace CubeRoverGround {
  ...
  namespace {
    ...
    typedef enum {
      TXCMD_COMPONENT_EXIT = Fw::ActiveComponentBase::ACTIVE_COMPONENT_EXIT,
  ...
  Fw::InputCmdPort *TxCmdComponentBase ::
  ...
  Svc::InputSchedPort *TxCmdComponentBase ::
  ...
  Fw::InputTlmPort *TxCmdComponentBase ::
  ...
  TxCmdComponentBase ::
    ...
    TxCmdComponentBase(const char* compName) :
  ...
  NATIVE_INT_TYPE TxCmdComponentBase ::
    ...
    )
  {
    ...
    FW_ASSERT(callComp);
    TxCmdComponentBase* compPtr =
      (TxCmdComponentBase*) callComp;
  ...
  Fw::QueuedComponentBase::MsgDispatchStatus TxCmdComponentBase ::
    doDispatch(void)
  {
    ComponentIpcSerializableBuffer msg;
    ...
    if (msgType == TXCMD_COMPONENT_EXIT) {
