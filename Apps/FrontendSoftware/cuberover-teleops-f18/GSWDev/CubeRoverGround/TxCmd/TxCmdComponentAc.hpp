// ====================================================================== 
// \title  TxCmdComponentAc.hpp
// \author Auto-generated
// \brief  hpp file for TxCmd component base class
//
// \copyright
...
#ifndef TXCMD_COMP_HPP_
#define TXCMD_COMP_HPP_
...
namespace CubeRoverGround {
  ...
  //! \class TxCmdComponentBase
  //! \brief Auto-generated base for TxCmd component
  //!
  class TxCmdComponentBase :
    public Fw::QueuedComponentBase
  {
    ...
    //!
    friend class TxCmdComponentBaseFriend;
  ...
  PROTECTED:
    ...
    //! Construct a TxCmdComponentBase object
    //!
    TxCmdComponentBase(
    ...
    //! Construct a TxCmdComponentBase object
    //!
    TxCmdComponentBase(void);
#endif

    //! Initialize a TxCmdComponentBase object
    //!
    void init(
    ...
    //! Destroy a TxCmdComponentBase object
    //!
    virtual ~TxCmdComponentBase(void);
