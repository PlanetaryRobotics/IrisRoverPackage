...
// \title  TxCmdImpl.hpp
// \author sofiahurtado
// \brief  hpp file for TxCmd component implementation class
//
// \copyright
...
namespace CubeRoverGround {
  ...
  class TxCmdComponentImpl :
    public TxCmdComponentBase
  {
