...
CMD_DESCRIPTION = "Read a named file off the disk. Divide it into packets and send the packets for transmission to the ground."

# Set arguments list with default values here.
ARGUMENTS = [
    ("sourceFileName","The name of the on-board file to send",StringType(max_string_len=60)), 
    ("destFileName","The name of the destination file on the ground",StringType(max_string_len=60)), 
    ]
