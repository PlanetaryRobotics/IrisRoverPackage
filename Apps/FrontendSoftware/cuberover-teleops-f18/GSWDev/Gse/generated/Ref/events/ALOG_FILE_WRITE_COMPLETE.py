...
NAME = "ALOG_FILE_WRITE_COMPLETE"
ID  = 0x1a6
SEVERITY = "ACTIVITY_HI"
FORMAT_STRING = "Event buffer write complete. Wrote %d records."
EVENT_DESCRIPTION = "Evemt log file write complete"

# Set arguments list with default values here.
ARGUMENTS = [
    ("records","number of records written",U32Type()), 
    ]
