...
NAME = "CS_CommandError"
ID  = 0x227
SEVERITY = "WARNING_HI"
FORMAT_STRING = "Sequence file %s: Command %d (opcode %d) completed with error %d"
EVENT_DESCRIPTION = "The Command Sequencer issued a command and received an error status in return."
...
ARGUMENTS = [
    ...
    ("opCode","The opcode",U32Type()), 
    ("errorStatus","The error status",U32Type()), 
    ]
