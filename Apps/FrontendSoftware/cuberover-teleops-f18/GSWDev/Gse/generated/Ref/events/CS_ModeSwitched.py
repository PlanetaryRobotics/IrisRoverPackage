...
NAME = "CS_ModeSwitched"
ID  = 0x22e
SEVERITY = "ACTIVITY_HI"
FORMAT_STRING = "Sequencer switched to %s step mode"
EVENT_DESCRIPTION = "Switched step mode"

# Set arguments list with default values here.
ARGUMENTS = [
    ("mode","The new mode",EnumType("SeqMode",{"SEQ_STEP_MODE":0,"SEQ_AUTO_MODE":1,})), 
    ]
