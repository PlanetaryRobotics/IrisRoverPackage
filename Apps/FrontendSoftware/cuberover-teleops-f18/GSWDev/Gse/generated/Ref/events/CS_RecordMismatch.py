...
NAME = "CS_RecordMismatch"
ID  = 0x229
SEVERITY = "WARNING_HI"
FORMAT_STRING = "Sequence file %s header records mismatch: %d in header, found %d extra bytes."
EVENT_DESCRIPTION = "Number of records in header doesn't match number in file"

# Set arguments list with default values here.
ARGUMENTS = [
    ("fileName","The name of the sequence file",StringType(max_string_len=60)), 
    ("header_records","The number of records in the header",U32Type()), 
    ("extra_bytes","The number of bytes beyond last record",U32Type()), 
    ]
