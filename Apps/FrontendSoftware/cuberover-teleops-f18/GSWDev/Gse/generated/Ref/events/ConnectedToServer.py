...
FORMAT_STRING = "Connection made to the socket server on port %d"
EVENT_DESCRIPTION = "The socket thread will continuously read until disconnected or terminated"
