...
NAME = "LostConnectionToServer"
ID  = 0x17f
SEVERITY = "WARNING_LO"
FORMAT_STRING = "Connection lost with socket server on port %d"
EVENT_DESCRIPTION = "The socket thread will continuously try to reconnect to socket server if connection dropped by server"
