...
NAME = "PrmFileLoadComplete"
ID  = 0x94
SEVERITY = "ACTIVITY_HI"
FORMAT_STRING = "Parameter file load completed. Read %d records."
EVENT_DESCRIPTION = "Load of parameter file completed"

# Set arguments list with default values here.
ARGUMENTS = [
    ("records","The number of records loaded",U32Type()), 
    ]
