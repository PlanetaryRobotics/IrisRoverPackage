...
NAME = "PrmFileSaveComplete"
ID  = 0x92
SEVERITY = "ACTIVITY_HI"
FORMAT_STRING = "Parameter file save completed. Wrote %d records."
EVENT_DESCRIPTION = "Save of parameter file completed"

# Set arguments list with default values here.
ARGUMENTS = [
    ("records","The number of records saved",U32Type()), 
    ]
