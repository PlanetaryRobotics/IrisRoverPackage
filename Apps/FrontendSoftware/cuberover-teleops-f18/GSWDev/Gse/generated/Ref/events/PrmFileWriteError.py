...
NAME = "PrmFileWriteError"
ID  = 0x91
SEVERITY = "WARNING_HI"
FORMAT_STRING = "Parameter write failed in stage %s with record %d and error %d"
EVENT_DESCRIPTION = "Failed to write parameter file"

# Set arguments list with default values here.
ARGUMENTS = [
    ("stage","The write stage",EnumType("PrmWriteError",{"PRM_WRITE_OPEN":0,"PRM_WRITE_DELIMETER":1,"PRM_WRITE_DELIMETER_SIZE":2,"PRM_WRITE_RECORD_SIZE":3,"PRM_WRITE_RECORD_SIZE_SIZE":4,"PRM_WRITE_PARAMETER_ID":5,"PRM_WRITE_PARAMETER_ID_SIZE":6,"PRM_WRITE_PARAMETER_VALUE":7,"PRM_WRITE_PARAMETER_VALUE_SIZE":8,})), 
