...
namespace Svc {
    ...
    )
  {
    ...
    if (this->m_LogText_OutputPort[0].isConnected()) {
      ...
      const char* _formatString =
        "(%s) %s: Assert in file %s, line %d";
#else
      const char* _formatString =
        "%s: Assert in file %s, line %d";
#endif
  ...
  void AssertFatalAdapterComponentBase ::
    log_FATAL_AF_ASSERT_1(
        Fw::LogStringArg& file, U32 line, U32 arg1
    )
  {
...
#if FW_OBJECT_NAMES == 1
      const char* _formatString =
        "(%s) %s: Assert in file %s, line %d: %d";
#else
      const char* _formatString =
        "%s: Assert in file %s, line %d: %d";
#endif
  ...
  void AssertFatalAdapterComponentBase ::
    log_FATAL_AF_ASSERT_2(
        Fw::LogStringArg& file, U32 line, U32 arg1, U32 arg2
    )
  {
...
#if FW_OBJECT_NAMES == 1
      const char* _formatString =
        "(%s) %s: Assert in file %s, line %d: %d %d";
#else
      const char* _formatString =
        "%s: Assert in file %s, line %d: %d %d";
#endif
  ...
  void AssertFatalAdapterComponentBase ::
    log_FATAL_AF_ASSERT_3(
        Fw::LogStringArg& file, U32 line, U32 arg1, U32 arg2, U32 arg3
    )
  {
...
#if FW_OBJECT_NAMES == 1
      const char* _formatString =
        "(%s) %s: Assert in file %s, line %d: %d %d %d";
#else
      const char* _formatString =
        "%s: Assert in file %s, line %d: %d %d %d";
#endif
  ...
  void AssertFatalAdapterComponentBase ::
    log_FATAL_AF_ASSERT_4(
        Fw::LogStringArg& file, U32 line, U32 arg1, U32 arg2, U32 arg3, U32 arg4
    )
  {
...
#if FW_OBJECT_NAMES == 1
      const char* _formatString =
        "(%s) %s: Assert in file %s, line %d: %d %d %d %d";
#else
      const char* _formatString =
        "%s: Assert in file %s, line %d: %d %d %d %d";
#endif
  ...
  void AssertFatalAdapterComponentBase ::
    log_FATAL_AF_ASSERT_5(
        Fw::LogStringArg& file, U32 line, U32 arg1, U32 arg2, U32 arg3, U32 arg4, U32 arg5
    )
  {
...
#if FW_OBJECT_NAMES == 1
      const char* _formatString =
        "(%s) %s: Assert in file %s, line %d: %d %d %d %d %d";
#else
      const char* _formatString =
        "%s: Assert in file %s, line %d: %d %d %d %d %d";
#endif
  ...
  void AssertFatalAdapterComponentBase ::
    log_FATAL_AF_ASSERT_6(
        Fw::LogStringArg& file, U32 line, U32 arg1, U32 arg2, U32 arg3, U32 arg4, U32 arg5, U32 arg6
    )
  {
...
#if FW_OBJECT_NAMES == 1
      const char* _formatString =
        "(%s) %s: Assert in file %s, line %d: %d %d %d %d %d %d";
#else
      const char* _formatString =
        "%s: Assert in file %s, line %d: %d %d %d %d %d %d";
#endif
  ...
  void AssertFatalAdapterComponentBase ::
    log_FATAL_AF_UNEXPECTED_ASSERT(
        Fw::LogStringArg& file, U32 line, U32 numArgs
    )
  {
...
#if FW_OBJECT_NAMES == 1
      const char* _formatString =
        "(%s) %s: Unexpected assert in file %s, line %d, args %d";
#else
      const char* _formatString =
        "%s: Unexpected assert in file %s, line %d, args %d";
#endif
