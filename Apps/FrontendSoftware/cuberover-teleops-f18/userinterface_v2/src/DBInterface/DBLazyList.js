 ...
 */
 ...
 // TODO: Find a way to implement dirty-bit checking reactively as alternative to staleTime.
  ...
  */
  ...
  get list(){
    if(this.needsUpdate || this.staleTime!==Infinity && new Date() > this.nextUpdateTime){
      let dataRead;
