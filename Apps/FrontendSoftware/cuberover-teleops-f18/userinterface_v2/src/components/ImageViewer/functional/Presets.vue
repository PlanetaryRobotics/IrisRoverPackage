<template>
  <div class="preset">
    <div class="preset__item" v-for="(preset, index) in presetList" :key="index">
      <p class="preset__item--name text__main">{{ preset.name }}</p>
      <div class="preset__item--visibility">
        <svg width="19" height="14" viewBox="0 0 19 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="presetIcon" :class="{presetIcon__selected: preset.visible}" @click="toggleVisibility(preset.name)">
        ...
        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg" class="presetIcon" :class="{presetIcon__selected: preset.global}" @click="toggleGlobal(preset.name)">
          ...
          <line x1="1.14746" y1="6.81042" x2="15.8519" y2="6.81042" stroke-linecap="round"/>
          <line x1="1.14746" y1="10.5883" x2="15.8519" y2="10.5883" stroke-linecap="round"/>
        </svg>
        <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg" class="presetIcon" :class="{presetIcon__selected: preset.shared}">
          <line x1="6.0045" y1="7.22018" x2="10.9688" y2="4.31807" stroke-linecap="round"/>
          <circle cx="13.0493" cy="2.88185" r="2.38185"/>
          <circle cx="3.80812" cy="8.45595" r="2.38185"/>
          <line x1="5.65336" y1="10.0963" x2="10.7889" y2="13.0663" stroke-linecap="round"/>
          <circle cx="13.1913" cy="14.1177" r="2.38185" transform="rotate(60 13.1913 14.1177)"/>
        </svg>
      </div>
    </div>
  </div>
...
export default {
  ...
  computed: {
    ...
    currentImage: function() {
      return this.images[this.scrollPos].name()
    },
