 ...
 * Filter({
  ...
  * Created: 4/6/2019
  * Last Update: 4/6/2019, Moosbrugger
 */
...
export default class Preset{
  constructor(inputData){
    ...
    */
    ...
    let adjustmentInputs = ["Exposure", "Contrast", "Denoise", "Highlights", "Shadows", "Whites", "Blacks"] // expected adjustment inputs
   ...
   toggleVisibility(imageName) {
     if (this.data.imageList.includes(imageName)) {
       this.data.imageList.splice( this.data.imageList.indexOf(imageName), 1 );
     }
     else {
