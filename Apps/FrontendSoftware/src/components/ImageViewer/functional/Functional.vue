...
<template>
  <div class="functional">
    ...
    <div class="functional__open">
      <FunctionalEdit
        v-show="isEdit"
        class="functional-edit"
      />
      <FunctionalFeatures
        v-show="isFeatures"
        class="functional-feat"
      />
    </div>
    <!-- SIDE MENU -->
    <div class="menu">
      ...
      >
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
          class="icon"
          :class="{ icon__selected: isFeatures }"
        ><circle
          cx="6.5"
          cy="6.5"
          r="2"
        /><path d="M1 7C1 11 4.5 18 6.5 18C8.5 18 12 11 12 7C12 4 10.5 1 6.5 1C2.5 1 1 4 1 7Z" /></svg>
      </div>
    </div>
  </div>
</template>
