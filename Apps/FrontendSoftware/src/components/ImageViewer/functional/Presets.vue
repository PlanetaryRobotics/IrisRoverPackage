  ...
  <div class="preset">
    <div class="preset__item" v-for="(preset, index) in presetList" :key="index">
      ...
      <div class=" preset__item--visibility">
        ...
        >
          <svg width="19" height="14" viewBox="0 0 19 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="presetIcon" @click="toggleVisibility(preset.name)">
        ...
        <div
          ...
          class="selectable-vector tooltip"
        >
          <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg" class="presetIcon" @click="toggleGlobal(preset.name)">
        ...
        <div
          ...
          class="selectable-vector tooltip"
        >
          <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg" class="presetIcon">
