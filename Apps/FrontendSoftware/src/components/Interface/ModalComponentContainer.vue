...
<template>
    ...
    >
        ...
        >
            <div class="modal-container--icon--box svg-clickless-container" v-html="CosmosIconPack(drawerIcon)" />
        </div>
        <div 
        v-show="showModalContent"
        ...
        >
            <div
                ...
                @drag.prevent="modalOnDrag($event)"
            >
                <div class="modal-content-container--header--title"> {{ headerText }} </div>
