<template>
  <!-- LANDER -->
  <g id="landerTransform">
    <!-- holds zoom transform -->
    <g id="landerGroup">
      <!-- holds original transform -->
      <svg
        id="lander"
        opacity="0.5"
        width="125"
      ...
      >
        ...
        <rect
          ...
          height="53.0658"
          rx="6"
          transform="rotate(-75 29.5847 80.9775)"
        ...
        <defs>
          <radialGradient
            ...
            gradientTransform="translate(62.2654 62.2653) rotate(60) scale(45.5813 45.5815)"
          >
          ...
          <radialGradient
            ...
            r="1"
            gradientUnits="userSpaceOnUse"
            gradientTransform="translate(56.1176 107.51) rotate(-44.8958) scale(74.1023)"
          >
