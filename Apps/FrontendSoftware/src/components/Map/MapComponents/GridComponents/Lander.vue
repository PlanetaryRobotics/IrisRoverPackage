<template>
  <!-- LANDER -->
  <g id = "landerTransform"> <!-- holds zoom transform -->
    <g id = "landerGroup"> <!-- holds original transform -->
      <svg opacity = "0.5" id = "lander" width="125" height="125" viewBox="0 0 125 125" fill="none" xmlns="http://www.w3.org/2000/svg">
