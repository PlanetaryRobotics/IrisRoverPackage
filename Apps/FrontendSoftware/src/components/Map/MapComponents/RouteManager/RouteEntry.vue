        ...
        <div class="segmentList__segment" v-for="(segment, index) in route.segmentList" :key="index">
          ...
          <div v-else>
            <div class="circumnav">
              ...
              <!-- EDIT ICON -->
              <svg @click.stop = "openEditCircumnavModal(segment, index)" class="icon pencil" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default {
  ...
  methods: {
    ...
    openEditCircumnavModal(circumnav, index) {
      GridEventBus.$emit("OPEN_SEGMENT_MODAL", {route: this.route, segment: circumnav, segmentIndex: index, action: "EDIT"});
    },
    enableHighlight() {
