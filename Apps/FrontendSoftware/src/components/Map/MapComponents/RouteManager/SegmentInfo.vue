<template>
  <div class="segmentInfo" 
    ...
    <div class="segment__header">
      <!-- ARROW -->
      <svg @click.stop="toggleCommands" width="14" height="7" viewBox="0 0 8 4" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon arrow" :class="{ open : show.commands }">
      ...
      <!-- EDIT ICON -->
      <svg v-if = "POIName === null" @click.stop="openEditModal()" class="icon pencil" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- TRASH ICON -->
      <svg v-if = "POIName === null" @click.stop="toggleDeleteModal()" class="icon trash" width="15" height="19" viewBox="0 0 15 19" fill="none" xmlns="http://www.w3.org/2000/svg">
