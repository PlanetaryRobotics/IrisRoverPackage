<template>
  <div>
    ...
    <div class="deletemodal">
      <!-- HEADER -->
      <div class="header">
        <svg width="15" height="19" viewBox="0 0 15 19" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
        ...
        <div class="header__text text__main--bold"> Delete Confirmation</div>
      </div>
