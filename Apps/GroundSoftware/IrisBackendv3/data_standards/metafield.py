...
class MetaField(Generic[_MF_DEF_T, _MF_CALC_T], ABC):
    ...
    def reset(self) -> None:
        ...
        self._time_of_last_calc = datetime.now()
...
class MetaModule:
    ...
    def _determine_downlink_times(factors: List[DownlinkedPayload]) -> DownlinkTimes:
        ...
        most_recent_time = datetime(1, 1, 1)
        for f in factors:
    ...
    def process(self, payload: DownlinkedPayload) -> List[DownlinkedPayload]:
        ...
        for field in meta_fields:
            ...
            result, factors = field.process(payload)
    ...
    if MAX_DEPTH == 0:
        ...
        for payload in payloads:
            for module in modules:
                generated_payloads.append(module.process(payload))
