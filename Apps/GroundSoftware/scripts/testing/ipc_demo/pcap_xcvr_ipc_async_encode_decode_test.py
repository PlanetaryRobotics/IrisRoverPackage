"""
Simple test that uses a PcapTransceiver to test IPC encode and decode while
running asynchronously. Basically just an async version of
`IrisBackendv3/ipc/_test_ipc_encode_decode_legacy.py`.

Mainly just saving this for posterity.
"""
