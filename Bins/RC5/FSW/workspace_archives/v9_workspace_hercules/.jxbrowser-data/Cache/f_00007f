...
function Mg(a,b){a.j=!1;a.C&&(a.l=!0,a.C.abort(),a.l=!1);a.o=b;Pg(a);Qg(a)}
function Pg(a){a.P||(a.P=!0,$e(a,"complete"),$e(a,"error"))}
l.abort=function(){this.C&&this.j&&(this.getStatus(),this.j=!1,this.l=!0,this.C.abort(),this.l=!1,$e(this,"complete"),$e(this,"abort"),Qg(this))};
l.D=function(){this.C&&(this.j&&(this.j=!1,this.l=!0,this.C.abort(),this.l=!1),Qg(this,!0));Hg.Y.D.call(this)};
l.Zb=function(){this.i()||(this.R||this.A||this.l?Tg(this):this.Sc())};
l.Sc=function(){Tg(this)};
function Tg(a){if(a.j&&"undefined"!=typeof Ma)if(a.J[1]&&4==Ug(a)&&2==a.getStatus())a.getStatus();else if(a.A&&4==Ug(a))Pf(a.Zb,0,a);else if($e(a,"readystatechange"),a.isComplete()){a.getStatus();a.j=!1;try{if(Vg(a))$e(a,"complete"),$e(a,"success");else{try{var b=2<Ug(a)?a.C.statusText:""}catch(c){b=""}a.o=b+" ["+a.getStatus()+"]";Pg(a)}}finally{Qg(a)}}}
function Qg(a,b){if(a.C){Ng(a);var c=a.C,d=a.J[0]?function(){}:null;
...
r(gh,I);var hh;hh=new function(a,b,c){this.j=a;this.fieldName=b;this.i=c;this.isRepeated=0;this.l=he}(175237375,{Jq:0},gh);function ih(a,b,c,d,e,f,g,h,k,m,q){Ze.call(this);var t=this;this.P="";this.l=[];this.Gb="";this.Hb=this.ra=-1;this.Oa=!1;this.J=this.o=null;this.G=0;this.uc=1;this.timeoutMillis=0;this.da=!1;Ze.call(this);this.Fb=b||function(){};
...
this.Da||(Oe(document,"visibilitychange",function(){"hidden"===document.visibilityState&&t.X()}),Oe(document,"pagehide",this.X,!1,this))}
...
k;this.J&&this.J.isSupported(h.length)&&(k=this.J.compress(h));var m={url:g,body:h,zc:1,xb:d,requestType:"POST",withCredentials:this.withCredentials,timeoutMillis:this.timeoutMillis},q=function(u){c.s.reset();Of(c.j,c.s.getValue());if(u){var A=null;try{var E=JSON.parse(u.replace(")]}'\n",""));A=new eh(E)}catch(F){}A&&(u=Number(Qd(A,1,"-1")),0<u&&(c.ra=Date.now(),c.Hb=c.ra+u),A=hh.l(A))&&(A=Qd(A,1,-1),-1!=A&&(c.Oa||nh(c,A)))}a&&a()},t=function(u,A){var E=Wd(e,ah,3),F=c.s;
F.i=Math.min(3E5,2*F.i);F.j=Math.min(3E5,F.i+Math.round(.2*(Math.random()-.5)*F.i));Of(c.j,c.s.getValue());401===u&&f&&(c.Gb=f);void 0===A&&(A=500<=u&&600>u||401===u||0===u);A&&(c.l=E.concat(c.l),c.W||c.j.enabled||c.j.start());b&&b("net-send-failed",u)},x=function(){c.Na?c.Na.send(m,q,t):c.sc(m,q,t)};
...
r(Yi,I);Yi.prototype.s=function(a){G(this,Ri,1,a)};
...
r(qj,I);qj.prototype.V=function(a){D(this,1,a)};function rj(a){I.call(this,a)}
...
r(Aj,I);Aj.prototype.V=function(a){D(this,1,a)};
function Cj(a,b){G(a,rj,2,b)}
var Bj=[3];function Dj(a){I.call(this,a)}
r(Dj,I);Dj.prototype.V=function(a){D(this,1,a)};function Ej(a){I.call(this,a)}
r(Ej,I);Ej.prototype.V=function(a){D(this,1,a)};function Fj(a){I.call(this,a)}
...
353,354,355,356,357,358,361,363,364,368,369,370,373,374,375,378,380,381,388,389,403,410,412,429,413,414,415,416,417,418,430,423,424,425,426,427,431,117,439,441];var Sj={Yi:0,Ji:1,Pi:2,Qi:4,Vi:8,Ri:16,Si:32,Xi:64,Wi:128,Li:256,Ni:512,Ui:1024,Mi:2048,Oi:4096,Ki:8192,Ti:16384};function nk(a){I.call(this,a)}
...
null==(t=Bh.screen)?void 0:t.availWidth;var x;e.u_cd=null==(x=Bh.screen)?void 0:x.colorDepth}catch(ea){}h=b.i;try{var u=h.screenX;var A=h.screenY}catch(ea){}try{var E=h.outerWidth;var F=h.outerHeight}catch(ea){}try{var O=h.innerWidth;var N=h.innerHeight}catch(ea){}try{var R=h.screenLeft;var ca=h.screenTop}catch(ea){}try{O=h.innerWidth,N=h.innerHeight}catch(ea){}try{var W=h.screen.availWidth;var ob=h.screen.availTop}catch(ea){}u=[R,ca,u,A,W,ob,E,F,O,N];try{var Xa=(b.i.top||window).document,la="CSS1Compat"==
...
r(Ro,Ze);Ro.prototype.L=function(){var a=B("yt.networkStatusManager.instance.isNetworkAvailable");return a?a.bind(this.l)():!0};
...
a.params){var ca=a.params;if("object"===typeof a.params)for(var W in ca){if(ca[W]){var ob="params."+W,Xa=Nr(ca[W]);g[ob]=Xa;N+=ob.length+Xa.length;if(500<N)break}}else g.params=Nr(ca)}if(m.length)for(var la=0;la<m.length&&!(N=Lr(m[la],"params.context."+la,g,N),500<=N);la++);navigator.vendor&&!g.hasOwnProperty("vendor")&&(g["device.vendor"]=navigator.vendor);var H={message:t,name:x,lineNumber:E,fileName:F,stack:O,params:g,sampleWeight:1},ka=Number(a.columnNumber);isNaN(ka)||(H.lineNumber=H.lineNumber+
":"+ka);if("IGNORED"===a.level)var ea=0;else a:{for(var Ae=Hr(),Be=p(Ae.na),wd=Be.next();!wd.done;wd=Be.next()){var na=wd.value;if(H.message&&H.message.match(na.Mq)){ea=na.weight;break a}}for(var up=p(Ae.ma),Tj=up.next();!Tj.done;Tj=up.next()){var vp=Tj.value;if(vp.callback(H)){ea=vp.weight;break a}}ea=1}H.sampleWeight=ea;for(var wp=p(Cr),Uj=wp.next();!Uj.done;Uj=wp.next()){var Vj=Uj.value;if(Vj.Za[H.name])for(var xp=p(Vj.Za[H.name]),Wj=xp.next();!Wj.done;Wj=xp.next()){var yp=Wj.value,Rg=H.message.match(yp.regexp);
if(Rg){H.params["params.error.original"]=Rg[0];for(var Xj=yp.groups,zp={},xd=0;xd<Xj.length;xd++)zp[Xj[xd]]=Rg[xd+1],H.params["params.error."+Xj[xd]]=Rg[xd+1];H.message=Vj.tb(zp);break}}}H.params||(H.params={});var Ap=Hr();H.params["params.errorServiceSignature"]="msg="+Ap.na.length+"&cb="+Ap.ma.length;H.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(H.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Db("sample").constructor!==
...
Rj,Yj);ur(Fp)}else{var Gp={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(Gp.systemHealth={crashData:{clientError:{logMessage:{message:H.message}}}});sm("appCrashed",Gp)}Qr++}else"WARNING"===h&&Ir.qa("handleWarning",H);if(M("kevlar_gel_error_routing"))a:{var Ce=h;if(M("errors_via_jspb")){if(Wr())var Ip=void 0;else{var yd=new hj;D(yd,1,H.stack);H.fileName&&D(yd,4,H.fileName);var Kb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Kb.length&&(1!==
Kb.length||isNaN(Number(Kb[0]))?2!==Kb.length||isNaN(Number(Kb[0]))||isNaN(Number(Kb[1]))||(D(yd,2,Number(Kb[0])),D(yd,3,Number(Kb[1]))):D(yd,2,Number(Kb[0])));var zc=new kj;D(zc,1,H.message);D(zc,3,H.name);D(zc,6,H.sampleWeight);"ERROR"===Ce?D(zc,2,2):"WARNING"===Ce?D(zc,2,1):D(zc,2,0);var Zj=new ij;D(Zj,1,!0);Xd(Zj,hj,3,jj,yd);var cc=new ej;D(cc,3,window.location.href);for(var Jp=L("FEXP_EXPERIMENTS",[]),ak=0;ak<Jp.length;ak++){var Ov=Jp[ak];Bd(cc);Pd(cc,5,2,!1).push(Ov)}var bk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
...
gk.setValue(Pp);Zd(cc,4,gj,gk)}var Sg=new lj;G(Sg,ej,1,cc);G(Sg,ij,2,Zj);G(Sg,kj,3,zc);Ip=Sg}var Qp=Ip;if(!Qp)break a;var Rp=new Qj;Xd(Rp,lj,163,Rj,Qp);ur(Rp)}else{if(Wr())var Sp=void 0;else{var De={stackTrace:H.stack};H.fileName&&(De.filename=H.fileName);var Lb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Lb.length&&(1!==Lb.length||isNaN(Number(Lb[0]))?2!==Lb.length||isNaN(Number(Lb[0]))||isNaN(Number(Lb[1]))||(De.lineNumber=Number(Lb[0]),De.columnNumber=Number(Lb[1])):De.lineNumber=
Number(Lb[0]));var hk={level:"ERROR_LEVEL_UNKNOWN",message:H.message,errorClassName:H.name,sampleWeight:H.sampleWeight};"ERROR"===Ce?hk.level="ERROR_LEVEL_ERROR":"WARNING"===Ce&&(hk.level="ERROR_LEVEL_WARNNING");var Pv={isObfuscated:!0,browserStackInfo:De},zd={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(zd.experimentIds=L("FEXP_EXPERIMENTS"));var ik=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Dk()&&ik)for(var Tp=p(Object.keys(ik)),Bc=Tp.next();!Bc.done;Bc=Tp.next()){var Up=
Bc.value;zd.kvPairs.push({key:Up,value:String(ik[Up])})}var jk=H.params;if(jk){var Vp=p(Object.keys(jk));for(Bc=Vp.next();!Bc.done;Bc=Vp.next()){var Wp=Bc.value;zd.kvPairs.push({key:"client."+Wp,value:String(jk[Wp])})}}var Xp=L("SERVER_NAME"),Yp=L("SERVER_VERSION");Xp&&Yp&&(zd.kvPairs.push({key:"server.name",value:Xp}),zd.kvPairs.push({key:"server.version",value:Yp}));Sp={errorMetadata:zd,stackTrace:Pv,logMessage:hk}}var Zp=Sp;if(!Zp)break a;sm("clientError",Zp)}if("ERROR"===Ce||M("errors_flush_gel_always_killswitch"))b:if(M("migrate_events_to_ts"))c:{if(M("web_fp_via_jspb")&&
...
r(nt,mt);nt.prototype.o=function(){return{input:"/getDatasyncIdsEndpoint",ta:Bs("/getDatasyncIdsEndpoint","GET"),ha:{}}};
...
D(b,13,V[Zt(a)]);(a=L("CLIENT_PROTOCOL"))&&D(b,33,a);(a=L("CLIENT_TRANSPORT"))&&D(b,34,a);(a=ms())&&"UNDEFINED_CSN"!==a&&D(b,4,a);a=pu();1!==a&&-1!==a||D(b,6,!0);a=It();if(M("skip_setting_info_in_csi_data_object"))Jt();else{d=Mt();c=[];for(e=0;e<d.length;e++){var f=c,g=f.push;var h=d[e];var k=Jj;if(null==h||""==h)k=new k;else{h=JSON.parse(h);if(!Array.isArray(h))throw Error("Expected to deserialize an Array but got "+Oa(h)+": "+h);ae=h;qd(h);k=new k(h);ae=null}g.call(f,k)}for(d=0;d<c.length&&"cold"!==
Qd(c[d],3,"");d++);}D(b,3,"cold");qu(a);a=ru();if(0<a.length)for(a=p(a),c=a.next();!c.done;c=a.next())c=c.value,d=new Ij,D(d,1,c),Zd(b,83,Ij,d);ou(b)}else{a=L("TIMING_INFO",{});for(b in a)a.hasOwnProperty(b)&&su(b,a[b]);b={isNavigation:!0,actionType:Zt(L("TIMING_ACTION"))};if(a=L("PREVIOUS_ACTION"))b.previousAction=Zt(a);if(a=L("CLIENT_PROTOCOL"))b.httpProtocol=a;if(a=L("CLIENT_TRANSPORT"))b.transportProtocol=a;(a=ms())&&"UNDEFINED_CSN"!==a&&(b.clientScreenNonce=a);a=pu();if(1===a||-1===a)b.isVisible=
!0;M("skip_setting_info_in_csi_data_object")?Jt():It();b.loadType="cold";qu(It());a=ru();if(0<a.length)for(b.resourceInfo=[],a=p(a),c=a.next();!c.done;c=a.next())b.resourceInfo.push({resourceCache:c.value});tu(b)}b=It();a=Lt();if("cold"===b.yt_lt||"cold"===a.loadType){c=Dt();d=Kt();d=d.gelTicks?d.gelTicks:d.gelTicks={};for(var m in c)m in d||Z(m,c[m]);m={};c=!1;d=p(Object.keys(b));for(e=d.next();!e.done;e=d.next())e=e.value,(e=$t(e,b[e]))&&!Pt(Lt(),e)&&(qt(a,e),qt(m,e),c=!0);c&&tu(m)}z("ytglobal.timingready_",
!0);m=L("TIMING_ACTION");B("ytglobal.timingready_")&&m&&"_start"in Dt()&&Ct()&&Ot()}
...
function Bu(a,b,c,d){if(void 0!==Au.i){if(d=Au.i,a=[a!==d.o,b!==d.M,c!==d.m,!1,!1,void 0!==d.j],a.some(function(e){return e}))throw new Q("InnerTubeTransportService is already initialized",a);
...
function Gu(a,b,c){var d;if(b&&!(null==b?0:null==(d=b.Vq)?0:d.Yq)&&a.l){d=p(yu);for(var e=d.next();!e.done;e=d.next())e=e.value,a.l[e]&&a.l[e].handleResponse(b,c)}}
function Fu(a,b,c){var d,e,f,g,h,k,m,q,t,x,u,A,E,F,O,N,R,ca,W,ob,Xa,la,H,ka,ea,Ae,Be,wd;return w(function(na){switch(na.i){case 1:na.u(2);break;case 3:if((d=na.j)&&!d.isExpired())return na.return(Promise.resolve(d.i()));case 2:if(null==(e=b)?0:null==(f=e.ha)?0:f.context)for(g=p([]),h=g.next();!h.done;h=g.next())k=h.value,k.Qq(b.ha.context);if(null==(m=a.j)||!m.Wq(b.input,b.ha)){na.u(4);break}return v(na,a.j.Lq(b.input,b.ha),5);case 5:return q=na.j,M("kevlar_process_local_innertube_responses_killswitch")||
Gu(a,q,b),na.return(q);case 4:return(u=null==(x=b.config)?void 0:x.Aa)&&a.i.has(u)&&M("web_memoize_inflight_requests")?t=a.i.get(u):(A=JSON.stringify(b.ha),O=null!=(F=null==(E=b.ta)?void 0:E.headers)?F:{},b.ta=Object.assign({},b.ta,{headers:Object.assign({},O,c)}),N=Object.assign({},b.ta),"POST"===b.ta.method&&(N=Object.assign({},N,{body:A})),(null==(R=b.config)?0:R.Xc)&&Z(b.config.Xc),ca=function(){return a.M.fetch(b.input,N,b.config)},t=ca(),u&&a.i.set(u,t)),v(na,t,6);
case 6:W=na.j;if(M("web_one_platform_error_handling")&&(null==(ob=W)?0:null==(Xa=ob.error)?0:Xa.details))for(la=W.error.details,H=p(la),ka=H.next();!ka.done;ka=H.next())ea=ka.value,(Ae=ea["@type"])&&-1<zu.indexOf(Ae)&&(delete ea["@type"],W=ea);u&&a.i.has(u)&&a.i.delete(u);(null==(Be=b.config)?0:Be.Yc)&&Z(b.config.Yc);if(W||null==(wd=a.j)||!wd.Fq(b.input,b.ha)){na.u(7);break}return v(na,a.j.Kq(b.input,b.ha),8);case 8:W=na.j;case 7:return Gu(a,W,b),na.return(W)}})}
...
"UNDEFINED_CSN"==b?dv("visualElementAttached",h,f):Ar(h,f,a)}else c={csn:b,parentVe:c.getAsJson(),childVes:hb(e,function(k){return k.getAsJson()})},"UNDEFINED_CSN"==b?dv("visualElementAttached",c,f):a?pr("visualElementAttached",c,a,f):sm("visualElementAttached",c,f)}
function Zu(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return dd(b,3)}
function dv(a,b,c){Yu.push({payloadName:a,payload:b,options:c});av||(av=ko())}
function lo(a){if(Yu){for(var b=p(Yu),c=b.next();!c.done;c=b.next())if(c=c.value,c.payload)if(M("il_via_jspb"))switch(c.payload.V(a.csn),c.payloadName){case "screenCreated":zr(c.payload,c.options);break;case "visualElementAttached":Ar(c.payload,c.options);break;case "visualElementShown":vr(c.payload,c.options);break;case "visualElementHidden":wr(c.payload,c.options);break;case "visualElementGestured":xr(c.payload,c.options);break;case "visualElementStateChanged":yr(c.payload,c.options);break;default:Vr(new Q("flushQueue unable to map payloadName to JSPB setter"))}else c.payload.csn=
...
Na(ev);function fv(){this.o=[];this.N=[];this.i=[];this.m=[];this.B=[];this.j=new Set;this.A=new Map}
fv.prototype.s=function(a){this.client=a};
...
fv.prototype.clickCommand=function(a,b,c){var d=a.clickTrackingParams;c=void 0===c?0:c;if(d)if(c=ms(void 0===c?0:c)){a=this.client;var e=gs(d);d={cttAuthInfo:os(c),ba:c};if(M("il_via_jspb")){var f=new Dj;f.V(c);e=e.getAsJspb();G(f,rj,2,e);D(f,4,Sj.INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK);b&&G(f,uj,3);"UNDEFINED_CSN"==c?dv("visualElementGestured",f,d):xr(f,d,a)}else f={csn:c,ve:e.getAsJson(),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"},b&&(f.clientData=b),"UNDEFINED_CSN"==c?
dv("visualElementGestured",f,d):a?pr("visualElementGestured",f,a,d):sm("visualElementGestured",f,d);b=!0}else b=!1;else b=!1;return b};
function iv(a,b,c){c=void 0===c?{}:c;a.j.add(c.layer||0);a.l=function(){jv(a,b,c);var f=ks(c.layer);if(f){for(var g=p(a.o),h=g.next();!h.done;h=g.next())h=h.value,hv(a,h[0],h[1]||f,c.layer);f=p(a.N);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=ms(g);var m=k[0]||ks(g);if(h&&m){g=a.client;var q=k[1];k={cttAuthInfo:os(h),ba:h};M("il_via_jspb")?(q=new Gj,q.V(h),m=m.getAsJspb(),G(q,rj,2,m),"UNDEFINED_CSN"==h?dv("visualElementStateChanged",q,k):yr(q,k,g)):(m={csn:h,ve:m.getAsJson(),
clientData:q},"UNDEFINED_CSN"==h?dv("visualElementStateChanged",m,k):g?pr("visualElementStateChanged",m,g,k):sm("visualElementStateChanged",m,k))}}}};
...
c.layer,c.cttAuthInfo);if(b=e&&"UNDEFINED_CSN"!==e&&d){a:{b=p(Object.values(es));for(f=b.next();!f.done;f=b.next())if(ms(f.value)===e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:os(e),ba:e,Qb:g},M("il_via_jspb")?(h=new Ej,h.V(e),d=d.getAsJspb(),G(h,rj,2,d),D(h,4,g?16:8),"UNDEFINED_CSN"==e?dv("visualElementHidden",h,f):wr(h,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"==e?dv("visualElementHidden",d,f):b?pr("visualElementHidden",d,b,f):sm("visualElementHidden",
d,f)));a.i[a.i.length-1]&&!a.i[a.i.length-1].csn&&(a.i[a.i.length-1].csn=k||"");tu({clientScreenNonce:k});ev.getInstance().clear();d=ks(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(M("web_mark_root_visible")||M("music_web_mark_root_visible"))&&(e=k,k={cttAuthInfo:os(e),ba:e},M("il_via_jspb")?(b=new Fj,b.V(e),f=d.getAsJspb(),G(b,rj,2,f),D(b,4,1),"UNDEFINED_CSN"==e?dv("visualElementShown",b,k):vr(b,k)):(b={csn:e,ve:d.getAsJson(),eventType:1},"UNDEFINED_CSN"==e?dv("visualElementShown",b,k):sm("visualElementShown",
b,k)));a.j.delete(c.layer||0);a.l=void 0;e=p(a.A);for(k=e.next();!k.done;k=e.next())b=p(k.value),k=b.next().value,b=b.next().value,b.has(c.layer)&&d&&hv(a,k,d,c.layer);for(c=0;c<a.m.length;c++){e=a.m[c];try{e()}catch(m){Ur(m)}}for(c=a.m.length=0;c<a.B.length;c++){e=a.B[c];try{e()}catch(m){Ur(m)}}}
...
Yv.prototype.cancel=function(){for(var a=p(this.i),b=a.next();!b.done;b=a.next())b=b.value,void 0===b.Xa||b.bb||this.l.fa(b.Xa),b.bb=!0;this.j.resolve()};
...
aw.prototype.transition=function(a,b){var c=this,d=this.B.find(function(f){return f.from===c.state&&f.F===a});
...
var gw;r(fw,ew);fw.prototype.m=function(){if(M("web_fp_via_jspb")){var a=new qj,b=ms();b&&a.V(b);b=new Qj;Xd(b,qj,380,Rj,a);ur(b);M("web_fp_via_jspb_and_json")&&sm("finalPayload",{csn:ms()})}else sm("finalPayload",{csn:ms()})};
...
yw.prototype.m=function(a,b){this.i()||this.j.qa.apply(this.j,arguments)};function zw(a,b,c){yw.call(this);this.l=a;this.destination=b;this.id=c}
...
r(Iw,Hw);function Jw(a,b,c,d){J.call(this);var e=this;this.A=b;this.webPlayerContextConfig=d;this.da=!1;this.api={};this.W=this.s=null;this.K=new K;this.j={};this.R=this.X=this.elementId=this.ra=this.config=null;this.P=!1;this.m=this.G=null;this.la={};this.Na=["onReady"];this.lastError=null;this.Da=NaN;this.J={};this.Oa=new Iw(this);this.T=0;this.l=this.o=a;pe(this,this.K);Kw(this);Lw(this);pe(this,this.Oa);c?this.T=el(function(){e.loadNewVideoConfig(c)},0):d&&(Mw(this),Nw(this))}
...
function Kw(a){a.da=!1;if(a.W)for(var b in a.j)a.j.hasOwnProperty(b)&&a.W(b,a.j[b]);for(var c in a.J)a.J.hasOwnProperty(c)&&fl(Number(c));a.J={};a.s=null;a.W=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
l.addEventListener=function(a,b){var c=this,d=Qw(this,b);d&&(0<=eb(this.Na,a)||this.j[a]||(b=ax(this,a),this.s&&this.s(a,b)),this.K.subscribe(a,d),"onReady"===a&&this.isReady()&&el(function(){d(c.api)},0))};
l.removeEventListener=function(a,b){this.i()||(b=Qw(this,b))&&ti(this.K,a,b)};
...
function ax(a,b){var c="ytPlayer"+b+a.A;a.j[b]=c;y[c]=function(d){var e=el(function(){if(!a.i()){try{a.K.qa(b,null!=d?d:void 0)}catch(h){Vr(new Q("PlayerProxy error when creating global callback",{error:h,event:b,playerId:a.A,data:d}))}var f=a.J,g=String(e);g in f&&delete f[g]}},0);
sb(a.J,String(e))};
return c}
...
l.D=function(){Vw(this);if(this.m&&this.config&&this.m.destroy)try{this.m.destroy()}catch(b){Ur(b)}this.la=null;for(var a in this.j)this.j.hasOwnProperty(a)&&(y[this.j[a]]=null);this.ra=this.config=this.api=null;delete this.o;delete this.l;J.prototype.D.call(this)};
