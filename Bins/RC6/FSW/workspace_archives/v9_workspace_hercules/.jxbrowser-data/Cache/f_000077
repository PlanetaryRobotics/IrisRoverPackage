...
c.prototype=b.prototype;a.Y=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Cq=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
;var Wh={Wh:"EMBEDDED_PLAYER_MODE_UNKNOWN",Th:"EMBEDDED_PLAYER_MODE_DEFAULT",Vh:"EMBEDDED_PLAYER_MODE_PFP",Uh:"EMBEDDED_PLAYER_MODE_PFL"},Xh={jq:"WEB_DISPLAY_MODE_UNKNOWN",fq:"WEB_DISPLAY_MODE_BROWSER",hq:"WEB_DISPLAY_MODE_MINIMAL_UI",iq:"WEB_DISPLAY_MODE_STANDALONE",gq:"WEB_DISPLAY_MODE_FULLSCREEN"};function Yh(){this.data_=[];this.i=-1}
...
function Tl(a,b,c){c=void 0===c?{}:c;var d={};L("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":L("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||L("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Bq||L("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().Aq:b=sg([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=L("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return d}
...
function ir(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,Yb:a,Ea:b,Dq:!!e,headers:{},postBodyFormat:"",postBody:""};M("use_request_time_ms_header")&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(P())));return a}
...
;function sm(a,b,c){c=void 0===c?{}:c;if(M("migrate_events_to_ts")){c=void 0===c?{}:c;var d=dq;L("ytLoggingEventsDefaultDisabled",!1)&&dq===dq&&(d=null);or(a,b,d,c)}else d=dq,L("ytLoggingEventsDefaultDisabled",!1)&&dq==dq&&(d=null),or(a,b,d,c)}
...
":"+ka);if("IGNORED"===a.level)var ea=0;else a:{for(var Ae=Gr(),Be=p(Ae.na),vd=Be.next();!vd.done;vd=Be.next()){var na=vd.value;if(H.message&&H.message.match(na.Lq)){ea=na.weight;break a}}for(var rp=p(Ae.ma),Sj=rp.next();!Sj.done;Sj=rp.next()){var sp=Sj.value;if(sp.callback(H)){ea=sp.weight;break a}}ea=1}H.sampleWeight=ea;for(var tp=p(Br),Tj=tp.next();!Tj.done;Tj=tp.next()){var Uj=Tj.value;if(Uj.Za[H.name])for(var up=p(Uj.Za[H.name]),Vj=up.next();!Vj.done;Vj=up.next()){var vp=Vj.value,Qg=H.message.match(vp.regexp);
if(Qg){H.params["params.error.original"]=Qg[0];for(var Wj=vp.groups,wp={},wd=0;wd<Wj.length;wd++)wp[Wj[wd]]=Qg[wd+1],H.params["params.error."+Wj[wd]]=Qg[wd+1];H.message=Uj.tb(wp);break}}}H.params||(H.params={});var xp=Gr();H.params["params.errorServiceSignature"]="msg="+xp.na.length+"&cb="+xp.ma.length;H.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(H.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Db("sample").constructor!==
...
Rj,Xj);tr(Cp)}else{var Dp={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(Dp.systemHealth={crashData:{clientError:{logMessage:{message:H.message}}}});sm("appCrashed",Dp)}Pr++}else"WARNING"===h&&Hr.qa("handleWarning",H);if(M("kevlar_gel_error_routing"))a:{var Ce=h;if(M("errors_via_jspb")){if(Vr())var Fp=void 0;else{var xd=new hj;D(xd,1,H.stack);H.fileName&&D(xd,4,H.fileName);var Jb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Jb.length&&(1!==
Jb.length||isNaN(Number(Jb[0]))?2!==Jb.length||isNaN(Number(Jb[0]))||isNaN(Number(Jb[1]))||(D(xd,2,Number(Jb[0])),D(xd,3,Number(Jb[1]))):D(xd,2,Number(Jb[0])));var yc=new kj;D(yc,1,H.message);D(yc,3,H.name);D(yc,6,H.sampleWeight);"ERROR"===Ce?D(yc,2,2):"WARNING"===Ce?D(yc,2,1):D(yc,2,0);var Yj=new ij;D(Yj,1,!0);Xd(Yj,hj,3,jj,xd);var bc=new ej;D(bc,3,window.location.href);for(var Gp=L("FEXP_EXPERIMENTS",[]),Zj=0;Zj<Gp.length;Zj++){var Ov=Gp[Zj];Bd(bc);Pd(bc,5,2,!1).push(Ov)}var ak=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
...
Number(Kb[0]));var gk={level:"ERROR_LEVEL_UNKNOWN",message:H.message,errorClassName:H.name,sampleWeight:H.sampleWeight};"ERROR"===Ce?gk.level="ERROR_LEVEL_ERROR":"WARNING"===Ce&&(gk.level="ERROR_LEVEL_WARNNING");var Pv={isObfuscated:!0,browserStackInfo:De},yd={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(yd.experimentIds=L("FEXP_EXPERIMENTS"));var hk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Dk()&&hk)for(var Qp=p(Object.keys(hk)),Ac=Qp.next();!Ac.done;Ac=Qp.next()){var Rp=
Ac.value;yd.kvPairs.push({key:Rp,value:String(hk[Rp])})}var ik=H.params;if(ik){var Sp=p(Object.keys(ik));for(Ac=Sp.next();!Ac.done;Ac=Sp.next()){var Tp=Ac.value;yd.kvPairs.push({key:"client."+Tp,value:String(ik[Tp])})}}var Up=L("SERVER_NAME"),Vp=L("SERVER_VERSION");Up&&Vp&&(yd.kvPairs.push({key:"server.name",value:Up}),yd.kvPairs.push({key:"server.version",value:Vp}));Pp={errorMetadata:yd,stackTrace:Pv,logMessage:gk}}var Wp=Pp;if(!Wp)break a;sm("clientError",Wp)}if("ERROR"===Ce||M("errors_flush_gel_always_killswitch"))b:if(M("migrate_events_to_ts"))c:{if(M("web_fp_via_jspb")&&
...
function Yr(a){a=p(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.Oq("ABORTED")}
...
return a.join("")}
;var bs=y.ytLoggingDocDocumentNonce_;bs||(bs=as(),z("ytLoggingDocDocumentNonce_",bs));var cs=bs;var ds={Ih:0,ke:1,ue:2,Dl:3,Kh:4,Up:5,sm:6,co:7,yn:8,Qn:9,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS",9:"RICH_GRID_WATCH"};function es(a){this.i=a}
...
Pn:45469,Rn:38669,Sn:13768,Tn:13777,Un:141842,Vn:62985,Wn:4724,Xn:59369,Yn:43927,Zn:43928,ao:12924,bo:100355,fo:56219,ho:27669,jo:10337,eo:47896,ko:122629,mo:139723,lo:139722,no:121258,oo:107598,po:127991,qo:96639,ro:107536,so:130169,to:96661,uo:145188,vo:96658,wo:116646,xo:121122,yo:96660,zo:127738,Ao:127083,Bo:155281,Co:147842,Do:104443,Eo:96659,Fo:147595,Go:106442,Ho:134840,Io:63667,Jo:63668,Ko:63669,Lo:130686,Mo:147036,No:78314,Oo:147799,Po:148649,Qo:55761,Ro:127098,So:134841,To:96368,Uo:67374,
Vo:48992,Wo:146176,Xo:49956,Yo:31961,Zo:26388,ap:23811,bp:5E4,cp:126250,ep:96370,fp:47355,gp:47356,hp:37935,ip:45521,jp:21760,kp:83769,lp:49977,mp:49974,np:93497,qp:93498,rp:34325,sp:140759,tp:115803,up:123707,vp:100081,wp:35309,xp:68314,yp:25602,zp:100339,Ap:143516,Bp:59018,Cp:18248,Dp:50625,Ep:9729,Fp:37168,Gp:37169,Hp:21667,Ip:16749,Jp:18635,Kp:39305,Lp:18046,Mp:53969,Np:8213,Op:93926,Pp:102852,Qp:110099,Rp:22678,Sp:69076,Tp:137575,Vp:139224,Wp:100856,Xp:154430,Yp:17736,Zp:3832,aq:147111,bq:55759,
cq:64031,kq:93044,lq:93045,mq:34388,nq:17657,oq:17655,pq:39579,qq:39578,rq:77448,sq:8196,tq:11357,uq:69877,wq:8197,xq:156512,yq:156509,zq:82039};function ss(){var a=vb(ts),b;return(new wf(function(c,d){a.onSuccess=function(e){dl(e)?c(new us(e)):d(new vs("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
LATENCY_ACTION_ONBOARDING:135,LATENCY_ACTION_LOGIN:97,LATENCY_ACTION_BROWSE:11,LATENCY_ACTION_CHANNELS:4,LATENCY_ACTION_WATCH:3,LATENCY_ACTION_RESULTS:2,LATENCY_ACTION_HOME:1,LATENCY_ACTION_STARTUP:106,LATENCY_ACTION_UNKNOWN:0};V[V.LATENCY_ACTION_KIDS_PROFILE_SWITCHER]="LATENCY_ACTION_KIDS_PROFILE_SWITCHER";V[V.LATENCY_ACTION_OFFLINE_THUMBNAIL_TRANSFER]="LATENCY_ACTION_OFFLINE_THUMBNAIL_TRANSFER";V[V.LATENCY_ACTION_CREATOR_VIDEO_VIDEO_EDITOR_ASYNC]="LATENCY_ACTION_CREATOR_VIDEO_VIDEO_EDITOR_ASYNC";
V[V.LATENCY_ACTION_CREATOR_VIDEO_VIDEO_EDITOR]="LATENCY_ACTION_CREATOR_VIDEO_VIDEO_EDITOR";V[V.LATENCY_ACTION_SPINNER_DISPLAYED]="LATENCY_ACTION_SPINNER_DISPLAYED";V[V.LATENCY_ACTION_PLAYABILITY_CHECK]="LATENCY_ACTION_PLAYABILITY_CHECK";V[V.LATENCY_ACTION_PROCESS]="LATENCY_ACTION_PROCESS";V[V.LATENCY_ACTION_APP_STARTUP]="LATENCY_ACTION_APP_STARTUP";V[V.LATENCY_ACTION_SHORTS_VIDEO_INGESTION_TRANSCODING]="LATENCY_ACTION_SHORTS_VIDEO_INGESTION_TRANSCODING";V[V.LATENCY_ACTION_COMMERCE_TRANSACTION]="LATENCY_ACTION_COMMERCE_TRANSACTION";
...
function Eu(a,b,c){var d;if(b&&!(null==b?0:null==(d=b.Sq)?0:d.Vq)&&a.l){d=p(wu);for(var e=d.next();!e.done;e=d.next())e=e.value,a.l[e]&&a.l[e].handleResponse(b,c)}}
function Du(a,b,c){var d,e,f,g,h,k,m,q,r,x,u,A,E,F,O,N,R,ca,W,ob,Ya,la,H,ka,ea,Ae,Be,vd;return w(function(na){switch(na.i){case 1:na.u(2);break;case 3:if((d=na.j)&&!d.isExpired())return na.return(Promise.resolve(d.i()));case 2:if(null==(e=b)?0:null==(f=e.ha)?0:f.context)for(g=p([]),h=g.next();!h.done;h=g.next())k=h.value,k.Nq(b.ha.context);if(null==(m=a.j)||!m.Tq(b.input,b.ha)){na.u(4);break}return v(na,a.j.Kq(b.input,b.ha),5);case 5:return q=na.j,M("kevlar_process_local_innertube_responses_killswitch")||
...
case 6:W=na.j;if(M("web_one_platform_error_handling")&&(null==(ob=W)?0:null==(Ya=ob.error)?0:Ya.details))for(la=W.error.details,H=p(la),ka=H.next();!ka.done;ka=H.next())ea=ka.value,(Ae=ea["@type"])&&-1<xu.indexOf(Ae)&&(delete ea["@type"],W=ea);u&&a.i.has(u)&&a.i.delete(u);(null==(Be=b.config)?0:Be.Yc)&&Z(b.config.Yc);if(W||null==(vd=a.j)||!vd.Eq(b.input,b.ha)){na.u(7);break}return v(na,a.j.Jq(b.input,b.ha),8);case 8:W=na.j;case 7:return Eu(a,W,b),na.return(W)}})}
