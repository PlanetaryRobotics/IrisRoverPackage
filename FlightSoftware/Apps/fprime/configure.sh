...
cd "$CUBEROVER_PACKAGE_TOP_LEVEL/FlightSoftware/Apps/fprime/mk/configs/compiler"
...
echo FPRIME_ROOT_LOC="$CUBEROVER_PACKAGE_TOP_LEVEL/FlightSoftware/Apps/fprime" >> defines_common.mk
