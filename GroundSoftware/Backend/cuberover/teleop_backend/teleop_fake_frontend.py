...
def main():
    ...
    left = {'args': {'Angle': 111, 'Images': 4, 'Speed': 11}, 'lookupID': 13, 'name': 'DriveLeftCommand'}
    right = {'args': {'Angle': 13, 'Images': 12, 'Speed': 3}, 'lookupID': 13, 'name': 'DriveRightCommand'}
    forward = {'args': {'Distance': 56, 'Images': 0, 'Speed': 1}, 'lookupID': 13, 'name': 'DriveForwardCommand'}
    backward = {'args': {'Distance': 200, 'Images': 60, 'Speed': 99}, 'lookupID': 13, 'name': 'DriveReverseCommand'}
    estop = {'args': {}, 'lookupID': 13, 'name': 'EStopCommand'}
    cmds = [left, right, forward, backward, estop]
